...
class CalendarManagerDelivery extends StatefulWidget {

  static String id = 'calendar_manager_delivery';

  @override
  _CalendarManagerDeliveryState createState() => _CalendarManagerDeliveryState();
}

class _CalendarManagerDeliveryState extends State<CalendarManagerDelivery> {
  ...
  void initState() {
    ...
    crudModel = CRUDModel(calendarSettingsDelivery);
    super.initState();
  }
